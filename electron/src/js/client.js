...
const TIER_URL = "http://mtgdraftwizard.herokuapp.com/tiers";
        ...
        return (
            <div
                ...
                <div
                    ...
                    <InfoWindow card={this.state.draftState.processedCards[this.state.hoverIndex]} show={this.state.hovering} index={this.state.hoverIndex} />
                </div>
                <div
                    style={{
                        display: "table-cell",
